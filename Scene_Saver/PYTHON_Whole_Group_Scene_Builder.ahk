		...
		if C_mode1
			{
				...
				if C_mode1 = "ct"
					...
					FileAppend,hue_groups(lnum = "%a_index%",lon = "%l_on1%",lbri = "%bri1%",lsat = "%sat1%",lx = "-1",ly = "-1",ltt = "4",lct = "%ct1%") `n,%Scenefile%
				...
				if C_mode1 = "xy"
					...
					FileAppend,hue_groups(lnum = "%a_index%",lon = "%l_on1%",lbri = "%bri1%",lsat = "%sat1%",lx = "%x_cord1%",ly = "%y_cord1%",ltt = "4",lct = "-1") `n,%Scenefile%
