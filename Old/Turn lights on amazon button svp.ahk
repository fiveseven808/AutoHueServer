...
PingCmd="C:\Program Files (x86)\WinHue 3\whc.exe" -lightstate:2 > Lightstate_Amazon.state
...
IfInString, whcresults, "on":true
	...
	IfInString, whcresults, "bri":2`,
		...
		;RunWait %comspec% /c """%PingCmd%""" ;,,Hide
		runwait, "C:\Program Files (x86)\WinHue 3\whc.exe" -g:1 -on:false
		runwait, "C:\Program Files (x86)\WinHue 3\whc.exe" -g:2 -on:true -bri:1 -ct:1
		runwait, "C:\Program Files (x86)\WinHue 3\whc.exe" -g:3 -on:false -bri:1
		}
	else
		runwait, "C:\Program Files (x86)\WinHue 3\whc.exe" -g:1 -on:false
	}
